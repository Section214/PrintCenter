		...
		makepot: {
			target: {
				options: {
					...
					exclude: ['build/.*'],
					mainFile: 'printcenter.php',    // Main project file.
					potFilename: 'printcenter.pot',    // Name of the POT file.
					potHeaders: {
					...
					processPot: function( pot, options ) {
						pot.headers['report-msgid-bugs-to'] = 'https://section214.com/';
