...
class WooCommerce_Product_Vendors {
    ...
    public function add_settings( $settings ) {
        ...
        $vendors_settings = array(
            array(  'title' => __( 'Product Vendors', 'printcenter' ), 'type' => 'title', 'id' => 'product_vendors_options' ),
    ...
    /**
     * Load woo_vendors text domain
     * @return void
     */
	public function load_localisation () {
		load_plugin_textdomain( 'printcenter' , false , dirname( plugin_basename( $this->file ) ) . '/lang/' );
	}

    /**
     * Setup woo_vendors text domain
     * @return void
     */
