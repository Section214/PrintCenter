...
function printcenter_add_menu_items() {
	add_submenu_page( 'edit.php?post_type=shop_commission', __( 'SSI Products', 'printcenter' ), __( 'SSI Products', 'printcenter' ), 'manage_options', 'edit.php?post_type=ssi_product' );
}
...
jQuery(document).ready( function($) {
    ...
    $('#menu-posts-shop_commission').removeClass('wp-not-current-submenu').addClass('wp-has-current-submenu wp-menu-open');
    $('#menu-posts-shop_commission a[href="edit.php?post_type=shop_commission"]:first').removeClass('wp-not-current-submenu').addClass('wp-has-current-submenu wp-menu-open');
    $('#menu-posts-shop_commission a[href="edit.php?post_type=ssi_product"]').addClass('current');
    $('#menu-posts-shop_commission a[href="edit.php?post_type=ssi_product"]').closest('li').addClass('current');
});
</script>
	<?php
}
add_action( 'admin_footer-post-new.php', 'printcenter_fix_active_menu_item' );
add_action( 'admin_footer-post.php', 'printcenter_fix_active_menu_item' );
