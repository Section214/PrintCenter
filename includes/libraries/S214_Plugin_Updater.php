<?php
/**
 * Section214 Plugin Updater
 *
 * @package     S214_Plugin_Updater
 * @since       1.0.0
 */
...
class S214_Plugin_Updater {
	...
	/**
	 * @access      private
	 * @var         string $api_data Data to send to the API
	 */
	...
	/**
	 * @access      private
	 * @var         string $name Plugin basename
	 */
	private $name = '';
	 ...
	 * @access      public
	 * @since       1.0.0
	 * @param       mixed $_data Plugin information
	 * @param       string $_action API action
	 * @param       object $_args Arguements for the API
	 * @return      object $_data Updated plugin information
	 */
	...
	/**
	 * Show the changelog if available
	 *
	 * @access      public
	 * @since       1.0.0
	 * @return      void
